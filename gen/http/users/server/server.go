...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"List", "GET", "/users"},
			{"Show", "GET", "/users/{email}"},
			{"Add", "POST", "/users"},
			{"Update", "PUT", "/users/{email}"},
			{"Remove", "DELETE", "/users/{email}"},
			{"Activate", "POST", "/users/activate"},
		},
...
func MountRemoveHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/users/{email}", f)
}
...
// MountActivateHandler configures the mux to serve the "users" service
// "activate" endpoint.
